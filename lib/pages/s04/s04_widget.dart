                                                ...
                                                Padding(
                                                  padding: const EdgeInsetsDirectional
                                                      .fromSTEB(
                                                          0.0, 0.0, 0.0, 10.0),
                                                  child: Text(
                                                    '\nThe \"electrical work\" service includes installation, repair, and maintenance of electrical systems. Services cover wiring, outlets, switches, circuit breakers, and lighting fixtures. Additional offerings may include safety inspections, energy-efficient upgrades, and emergency electrical repairs.',
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodyMedium
                                                        .override(
                                                ...
                                                Padding(
                                                  padding: const EdgeInsetsDirectional
                                                      .fromSTEB(
                                                          0.0, 20.0, 0.0, 0.0),
                                                  child: Text(
                                                    'Wiring and Cables, Electrical Outlets and Switches, Lighting Fixtures, Electrical Tools and Testers',
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodyMedium
                                                        .override(
