...
import 'booking_s01_model.dart';
export 'booking_s01_model.dart';

class BookingS01Widget extends StatefulWidget {
  const BookingS01Widget({super.key});

  @override
  State<BookingS01Widget> createState() => _BookingS01WidgetState();
}

class _BookingS01WidgetState extends State<BookingS01Widget>
    with TickerProviderStateMixin {
  late BookingS01Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BookingS01Model());
